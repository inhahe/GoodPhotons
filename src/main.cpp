        ...
        if (!cudaAvailable()) {
            ...
            if (!cudaBdptSupported(scene)) {
                const char* why = "scene has a BDPT-GPU-unsupported feature "
                                  ...
                                  "spot/env/collimated light, a per-hit procedural "
                                  "pattern the GPU BDPT can't MIS, or a forward-CPU-only "
                                  "feature: frosted-or-colored glass)";
            ...
            const char* why = "GPU-unsupported feature (frosted/colored glass, layered "
                              "material, indexed palette, or oversized multilayer/mix "
                              "material)";
