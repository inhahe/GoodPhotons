        ...
        if (!cudaAvailable()) {
            ...
            if (!cudaBdptSupported(scene)) {
                const char* why = "scene has a BDPT-GPU-unsupported feature "
                                  ...
                                  "feature: procedural pattern / frosted-or-colored glass)";
            ...
            const char* why = "GPU-unsupported feature (procedural pattern, frosted/"
                              "colored glass, layered material, indexed palette, or "
                              "oversized multilayer/mix material)";
